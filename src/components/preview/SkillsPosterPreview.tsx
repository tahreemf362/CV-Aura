...
export const SkillsPosterPreview = () => {
  ...
  const renderAuroraNeonGrid = () => {
    return (
      <div className="bg-gradient-to-br from-indigo-950 via-purple-900 to-slate-950 text-white p-8 md:p-12 rounded-3xl shadow-2xl flex flex-col gap-6 font-sans relative overflow-hidden border border-purple-500/20">
        {/* Glow Effects */}
  ...
  const renderSunsetMinimalist = () => {
    return (
      <div className="bg-gradient-to-br from-amber-500 via-rose-500 to-violet-650 text-white p-8 md:p-12 rounded-3xl shadow-2xl flex flex-col gap-8 font-sans border border-rose-400/20 relative">
